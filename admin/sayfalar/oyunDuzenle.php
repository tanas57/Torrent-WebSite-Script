...
$id  	= $_GET["id"];
	if($_POST == TRUE){
		...
		switch($adim){
			...
			$say = mysql_num_rows(mysql_query("select id from oyunlar where seo='$seo' and id!='$id'"));
			if($say < 1){
				$ekle = mysql_query("update oyunlar set adi='$adi',aciklama='$aciklama',turu='$turu',seo='$seo',yili='$yili' where id='$id'");
				if($ekle) echo "<div class=\"uyar basarili\"><img src=\"images/icon/basarili.png\"><span>Oyun Güncellendi. Adım 2ye geç!</span></div>";
				else echo "<div class=\"uyar error\"><img src=\"images/icon/errors.png\"><span>Oyun güncellenemedi .".mysql_error()."</span></div>";
			}
			else{
				echo "<div class=\"uyar error\"><img src=\"images/icon/errors.png\"><span>Oyun daha önce eklenmiş.</span></div>";
			}
			...
			$guncelle 			= mysql_query("update oyunlar set icerik='$icerik' where id='$id'");
			...
			BaglantiAc();
			$guncelle = mysql_query("update oyunlar set surum='$surum',platform='$platform',boyut='$boyut',tanitim='$tanitim' where id='$id'");
			...
			BaglantiAc();
			$guncelle = mysql_query("update oyunlar set link1='$link1',link2='$link2' where id='$id'");
			...
			$guncelle = mysql_query("update oyunlar set eklenme='$eklenme',durum='$durum' where id='$id'");
			if($guncelle) echo "<div class=\"uyar basarili\"><img src=\"images/icon/basarili.png\"><span>Oyun güncelleme: başarılı :)</span></div>";
			else echo "<div class=\"uyar error\"><img src=\"images/icon/errors.png\"><span>Oyun güncellenemedi .".mysql_error()."</span></div>";
			// session bitir
			unset($_SESSION['seoOyun']);
			BaglantiKapat();
			break;
		}
	}
BaglantiAc();
$goster_sql = mysql_query("select * from oyunlar where id='$id'");
$ceks = mysql_fetch_array($goster_sql);
	$adi		= $ceks["adi"];
	$_SESSION["seoOyun"] = $ceks["seo"];
...
<h3 class="anabaslik"> Oyun Duzenle </h3>
<ul>
	<li><a href="yonetim.php?s=oyunDuzenle&a=1&id=<?php echo @$id;?>">Adım 1</a></li>
	<li><a href="yonetim.php?s=oyunDuzenle&a=2&id=<?php echo @$id;?>">Adım 2</a></li>
	<li><a href="yonetim.php?s=oyunDuzenle&a=3&id=<?php echo @$id;?>">Adım 3</a></li>
	<li><a href="yonetim.php?s=oyunDuzenle&a=4&id=<?php echo @$id;?>">Adım 4</a></li>
	<li><a href="yonetim.php?s=oyunDuzenle&a=5&id=<?php echo @$id;?>">Adım 5</a></li>
	<li><a href="yonetim.php?s=oyunDuzenle&a=6&id=<?php echo @$id;?>">Adım 6</a></li>
</ul>
<hr/>
