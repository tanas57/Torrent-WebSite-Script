<?php ob_start(); ?>
<div class="yanyana">
<h3 class="anabaslik"><?php echo "Gebe Bildirimi Onay Kaldırma"; ?> </h3>
<?php
$gelen	=	$_GET["id"];
$urun_sil	=	mysql_query("update gebebildirimleri set gebe_durum='0' where id=$gelen");
	if ($urun_sil == true)
	{
...
?>
<center>
<a href="yonetim.php?s=gebeler">Geri Dön</a>
</center>
</div>
