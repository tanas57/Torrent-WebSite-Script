...
if(@$_SESSION["seo"] != ""){
	...
	if($_POST == TRUE){
		...
		switch($adim){
			...
			$_SESSION["seo"] = $seo;
			$_SESSION["tur"] = "programEkle";
			$say = mysql_num_rows(mysql_query("select id from programlar where seo='$seo'"));
			if($say < 1){
				$ekle = mysql_query("insert into programlar(adi,aciklama,turu,seo,yili) values('$adi','$aciklama','$turu','$seo','$yili')");
				if($ekle) echo "<div class=\"uyar basarili\"><img src=\"images/icon/basarili.png\"><span>Program Eklendi. Adım 2ye geç!</span></div>";
				else echo "<div class=\"uyar error\"><img src=\"images/icon/errors.png\"><span>Program eklenemedi .".mysql_error()."</span></div>";
			}
			else{
				echo "<div class=\"uyar error\"><img src=\"images/icon/errors.png\"><span>Program daha önc eklenmiş.</span></div>";
			}
			...
			$guncelle 			= mysql_query("update programlar set icerik='$icerik' where seo='$seo'");
			...
			BaglantiAc();
			$guncelle = mysql_query("update programlar set kullanim='$kullanim',platform='$platform',boyut='$boyut',tanitim='$tanitim' where seo='$seo'");
			...
			BaglantiAc();
			$guncelle = mysql_query("update programlar set link1='$link1',link2='$link2' where seo='$seo'");
			...
			$guncelle = mysql_query("update programlar set eklenme='$eklenme',durum='1' where seo='$seo'");
			if($guncelle) echo "<div class=\"uyar basarili\"><img src=\"images/icon/basarili.png\"><span>Program ekleme işlemi başarılı :)</span></div>";
			else echo "<div class=\"uyar error\"><img src=\"images/icon/errors.png\"><span>Program eklenemedi .".mysql_error()."</span></div>";
			// session bitir
			unset($_SESSION['seo']);
			BaglantiKapat();
...
if($seos != ""){
	BaglantiAc();
	$sqls 		= mysql_query("select * from programlar where seo='$seos'");
...
<ul>
	<li><a href="yonetim.php?s=programEkle&a=1&seo=<?php echo @$_SESSION["seo"];?>">Adım 1</a></li>
	<li><a href="yonetim.php?s=programEkle&a=2&seo=<?php echo @$_SESSION["seo"];?>">Adım 2</a></li>
	<li><a href="yonetim.php?s=programEkle&a=3&seo=<?php echo @$_SESSION["seo"];?>">Adım 3</a></li>
	<li><a href="yonetim.php?s=programEkle&a=4&seo=<?php echo @$_SESSION["seo"];?>">Adım 4</a></li>
	<li><a href="yonetim.php?s=programEkle&a=5&seo=<?php echo @$_SESSION["seo"];?>">Adım 5</a></li>
	<li><a href="yonetim.php?s=programEkle&a=6&seo=<?php echo @$_SESSION["seo"];?>">Adım 6</a></li>
</ul>
<hr/>
...
$adim = $_GET["a"];
		...
		<input style="margin-top:15px; margin-bottom:33px; height:44px;" type="submit" value="Programı Ekle" />	
	</div>
	...
	<div style="width:200px; float:left;">
		...
		<input style="height:60px;" name="aciklama" type="text" value="<?php echo @$aciklama; ?>" size="25" maxlength="300" />
			...
			case 6: ?>
			<input type="hidden" name="bok" />
			<input style="margin-top:15px; margin-bottom:33px; height:44px;" type="submit" value="Programı paylaş" />
			<?php break;
		}
?>
	</form>
