...
$adim = $_GET["a"];	
		...
		switch($adim){
			...
			$say = mysql_num_rows(mysql_query("select id from dizi_bolumler where seo='$seo' and id!='$id'"));
			if($say < 1){
				$ekle = mysql_query("update dizi_bolumler set adi='$adi',aciklama='$aciklama',kalite='$kalite',seo='$seo',sezon='$sezon',bolum='$bolum',dizi_id='$dizi_id' where id='$id'");
				if($ekle) echo "<div class=\"uyar basarili\"><img src=\"images/icon/basarili.png\"><span>Dizi Bölüm Güncellendi. Adım 2ye geç!</span></div>";
			...
			$guncelle 			= mysql_query("update dizi_bolumler set icerik='$icerik' where id='$id'");
			...
			BaglantiAc();
			$guncelle = mysql_query("update dizi_bolumler set surum='$surum1',boyut='$boyut',fragman='$fragman' where id='$id'");
			...
			BaglantiAc();
			$guncelle = mysql_query("update dizi_bolumler set link1='$link1',link2='$link2' where id='$id'");
			...
			$guncelle = mysql_query("update dizi_bolumler set eklenme='$eklenme',durum='$durum' where id='$id'");
			if($guncelle) echo "<div class=\"uyar basarili\"><img src=\"images/icon/basarili.png\"><span>Dizi Bölümü güncellendi</span></div>";
			else echo "<div class=\"uyar error\"><img src=\"images/icon/errors.png\"><span>Dizi Bölüm güncellenemedi .".mysql_error()."</span></div>";
			// session bitir
			unset($_SESSION['dizi_seo']);
			BaglantiKapat();
			break;
		}
	}
...
<h3 class="anabaslik"> Dizi Bölümü Güncelle </h3>
<ul>
	<li><a href="yonetim.php?s=diziBolumDuzenle&a=1&id=<?php echo @$id;?>">Adım 1</a></li>
	<li><a href="yonetim.php?s=diziBolumDuzenle&a=2&id=<?php echo @$id;?>">Adım 2</a></li>
	<li><a href="yonetim.php?s=diziBolumDuzenle&a=3&id=<?php echo @$id;?>">Adım 3</a></li>
	<li><a href="yonetim.php?s=diziBolumDuzenle&a=4&id=<?php echo @$id;?>">Adım 4</a></li>
	<li><a href="yonetim.php?s=diziBolumDuzenle&a=5&id=<?php echo @$id;?>">Adım 5</a></li>
	<li><a href="yonetim.php?s=diziBolumDuzenle&a=6&id=<?php echo @$id;?>">Adım 6</a></li>
</ul>
<hr/>
