...
if(! defined('FILE_CACHE_PREFIX') ) 		define ('FILE_CACHE_PREFIX', 'img');				// What to put at the beg of all files in the cache directory so we can identify them
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', './files/cache');				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
if(! defined('NOT_FOUND_IMAGE') )			define ('NOT_FOUND_IMAGE', 'http://www.fulltorrentler.com/files/images/style/no_photo.jpg');							// Image to serve if any 404 occurs 
